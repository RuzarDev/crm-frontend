  ...
  <div class="dt-section">
    ...
    <div class="dt-grid-4">
      <a-form-item label="Вид документа">
        <a-input v-model:value="form.deferralDocType" :disabled="readonly" @change="emitChange" />
      </a-form-item>
    ...
    <a-form-item>
      ...
      <a-input v-model:value="form.guaranteeInvalidFor" :disabled="readonly" @change="emitChange" />
    </a-form-item>

    <div class="dt-section-bar"><DtGraphLabel graph="54" text="Место, дата, подписант" /></div>
    <div class="dt-grid-3">
      <a-form-item label="ФИО">
        <a-input v-model:value="form.signatoryFullName" :disabled="readonly" @change="emitChange" />
      </a-form-item>
      <a-form-item label="Должность">
        <a-input v-model:value="form.signatoryPosition" :disabled="readonly" @change="emitChange" />
      </a-form-item>
      <a-form-item label="Документ">
        <a-input v-model:value="form.signatoryDocument" :disabled="readonly" @change="emitChange" />
      </a-form-item>
