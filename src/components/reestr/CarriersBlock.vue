<!-- crm-frontend/src/components/reestr/CarriersBlock.vue -->
<!-- КЕДЕН-транзит §3 Перевозчики и представители при транзите, повтор. -->
<template>
...
const emit = defineEmits<{
  (e: 'update:modelValue', value: ReestrCarrierInput[]): void
}>()
...
const roleOptions = CARRIER_ROLE_OPTIONS
...
const items = ref<ReestrCarrierInput[]>([])
