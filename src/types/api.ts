...
export const EAES_DOC_CODES: { code: string; name: string }[] = [
  ...
  // Разрешительные документы / сертификаты (гр.44)
  { code: '01091', name: 'Заключение на ввоз/вывоз шифровальных средств' },
  ...
  { code: '01221', name: 'Документы о соблюдении запретов/ограничений (временные меры РК)' },
  { code: '01243', name: 'Экспортный сертификат на сельхозпродукцию' },
  { code: '01999', name: 'Иные документы о соблюдении запретов и ограничений' },
